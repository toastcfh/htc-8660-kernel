...
#elif defined(CONFIG_ARCH_MSM7230) && (defined(CONFIG_MACH_VIVO) || defined(CONFIG_MACH_SAGA) || defined(CONFIG_MACH_FLYER) || defined(CONFIG_MACH_ICON) || defined(CONFIG_MACH_EXPRESS_KT) || defined(CONFIG_MACH_TAG) || defined(CONFIG_MACH_BLISS) || defined(CONFIG_MACH_RUNNYMEDE))
