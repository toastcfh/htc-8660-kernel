...
static uint32_t flash_gpio_table[] = {
	GPIO_CFG(29, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
...
static int flashlight_turn_off(void)
{
	...
	gpio_tlmm_config(flash_gpio_table[0], GPIO_CFG_ENABLE);
...
int tps61310_flashlight_control(int mode)
{
	...
	break;
	case FL_MODE_FLASH:
		gpio_tlmm_config(flash_gpio_table[1], GPIO_CFG_ENABLE);
		tps61310_i2c_command(0x01, 0x10);
		...
		tps61310_i2c_command(0x03, 0xE1);
	...
	case FL_MODE_FLASH_LEVEL1:
		gpio_tlmm_config(flash_gpio_table[1], GPIO_CFG_ENABLE);
		tps61310_i2c_command(0x01, 0x08);
		tps61310_i2c_command(0x05, 0x6F);
		tps61310_i2c_command(0x00, 0x00);
		tps61310_i2c_command(0x02, 0x04);
		gpio_set_value(this_tps61310->strb0, 1);
		gpio_set_value(this_tps61310->strb1, 0);
		tps61310_i2c_command(0x03, 0xE1);
	...
	case FL_MODE_FLASH_LEVEL2:
		gpio_tlmm_config(flash_gpio_table[1], GPIO_CFG_ENABLE);
		tps61310_i2c_command(0x01, 0x04);
		tps61310_i2c_command(0x05, 0x6F);
		tps61310_i2c_command(0x00, 0x00);
		tps61310_i2c_command(0x02, 0x02);
		gpio_set_value(this_tps61310->strb0, 1);
		gpio_set_value(this_tps61310->strb1, 0);
		tps61310_i2c_command(0x03, 0xE1);
						...
						enum led_brightness brightness)
{
	...
	if (brightness > 0 && brightness <= LED_HALF) {
		...
		else if (brightness == 1 && this_tps61310->led_count)
			mode = FL_MODE_TORCH_LED_A;
		else if (brightness == 2 && this_tps61310->led_count)
					...
					const struct i2c_device_id *id)
{
	...
	tps61310->led_count 		  = pdata->led_count;
