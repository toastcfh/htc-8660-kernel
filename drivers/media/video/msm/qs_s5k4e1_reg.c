...
struct qs_s5k4e1_i2c_reg_conf qs_s5k4e1_snap_3d[] = {
	{0x0100, 0x00},
	/*Frame Length*/
	{0x0340, 0x09}, /*0x04*//*7bc*/
	{0x0341, 0x82}, /*0xB4*/
	/*Line Length*/
	{0x0342, 0x0A},
	{0x0343, 0xB2},
...
struct qs_s5k4e1_i2c_reg_conf qs_s5k4e1_prev_3d[] = {
	{0x0100, 0x00},
	/*Frame Length*/
	{0x0340, 0x04},/*442*/
	{0x0341, 0xCD},
...
struct qs_s5k4e1_i2c_reg_conf qs_s5k4e1_prev_3d_old[] = {
	{0x0100, 0x00},
	{0x0340, 0x03},
	{0x0341, 0xe0},
	{0x0342, 0x0A},
...
struct qs_s5k4e1_i2c_conf_array qs_s5k4e1_confs[] = {
	...
	{&qs_s5k4e1_prev_3d[0], \
		ARRAY_SIZE(qs_s5k4e1_prev_3d)},
	{&qs_s5k4e1_snap_3d[0], \
		ARRAY_SIZE(qs_s5k4e1_snap_3d)},
};
